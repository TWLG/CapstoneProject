// dummy.js - Simulates an Arduino device sending sensor data to the server
...
const deviceName = "DummyArduino1"; // Unique device identifier
...
const connectToServer = () => {
    ...
    const socket = new WebSocket(
        `ws://backend:4000?role=device&deviceName=${encodeURIComponent(deviceName)}&apiKey=${encodeURIComponent(apiKey)}`
    );
